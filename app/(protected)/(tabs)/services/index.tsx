  ...
  return (
    <ThemedView style={styles.container}>
      <ScrollView style={styles.scrollView}>
        {/* Vehicle Info Card */}
        <ThemedView style={[styles.vehicleCard, { backgroundColor: Colors[colorScheme ?? 'light'].background }]}>
          <ThemedView style={styles.vehicleHeader}>
            <Ionicons name="car-sport" size={32} color="#4a90e2" />
            <ThemedView style={styles.vehicleInfo}>
              <ThemedText type="title">{carData.year} {carData.make} {carData.model}</ThemedText>
              <ThemedText style={styles.licensePlate}>{carData.licensePlate}</ThemedText>
            </ThemedView>
          </ThemedView>
          ...
          <ThemedView style={styles.vehicleDetails}>
            <ThemedView style={styles.detailItem}>
              ...
              <ThemedText>{carData.vin}</ThemedText>
            </ThemedView>
            <ThemedView style={styles.detailItem}>
              <ThemedText style={styles.detailLabel}>Mileage</ThemedText>
              <ThemedText>{carData.mileage.toLocaleString()} mi</ThemedText>
            </ThemedView>
            <ThemedView style={styles.detailItem}>
              <ThemedText style={styles.detailLabel}>Last Service</ThemedText>
              <ThemedText>{formatDate(carData.lastService)}</ThemedText>
            </ThemedView>
            <ThemedView style={styles.detailItem}>
              <ThemedText style={styles.detailLabel}>Next Service Due</ThemedText>
              <ThemedText style={styles.nextService}>
                {formatDate(carData.nextService)}
                <ThemedText style={styles.daysAway}> (30 days)</ThemedText>
              </ThemedText>
            </ThemedView>
          </ThemedView>
          ...
          <ThemedView style={styles.progressContainer}>
            <ThemedView style={styles.progressHeader}>
              <ThemedText>Work Done</ThemedText>
              <ThemedText>{progress}% Complete</ThemedText>
            </ThemedView>
            <ThemedView style={styles.progressBar}>
              <ThemedView 
                style={[
                  styles.progressFill, 
                  { width: `${progress}%`, backgroundColor: progress > 70 ? 'rgba(0, 255, 0, 0.5)' : progress > 40 ? 'rgba(255, 255, 0, 0.5)' : 'rgba(255, 0, 0, 0.5)' }
                ]} 
              />
            </ThemedView>
          </ThemedView>
